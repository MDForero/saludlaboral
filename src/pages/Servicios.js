    ...
    <div>
      ...
      <article className="services">
        <div className='text'>
          ...
          <p>Prueba diagnóstica que registra la actividad eléctrica del corazón con el n de detectar isquemias y arritmias cardíacas, evaluar los factores de riesgos cardiovasculares y realizar valoración preoperatoria.</p>
        </div>
